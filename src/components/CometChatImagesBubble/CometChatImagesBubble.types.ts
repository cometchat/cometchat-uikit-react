...
export interface CometChatImagesBubbleAttachment {
...
/** Visual variant for the images bubble. */
export type CometChatImagesBubbleVariant = 'incoming' | 'outgoing';

/** Layout type determined by attachment count. */
export type CometChatImagesBubbleLayoutType = 'single' | 'grid' | 'grid-2x2' | 'overflow';
