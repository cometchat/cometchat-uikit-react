    ...
    const renderItems = conversationList.map((conversation) => {
        ...
        return (
            <CometChatConversationListItem
                ...
                isActive={isActive}
                conversationInputData={_conversationListItemConfiguration?.conversationInputData}
                ...
                hideDeletedMessages={_conversationListItemConfiguration?.hideDeletedMessages}
                hideGroupActions={_conversationListItemConfiguration?.hideGroupActions}
                showTypingIndicator={_conversationListItemConfiguration?.showTypingIndicator}
                typingIndicatorText={typingIndicatorText}
                hideThreadIndicator={_conversationListItemConfiguration?.hideThreadIndicator}
                threadIndicatorText={localize("IN_A_THREAD")}
                theme={_theme}
                onClick={itemClickhandler.bind(this)}
                avatarConfiguration={_conversationListItemConfiguration?.avatarConfiguration}
                statusIndicatorConfiguration={_conversationListItemConfiguration?.statusIndicatorConfiguration}
                badgeCountConfiguration={_conversationListItemConfiguration?.badgeCountConfiguration}
                messageReceiptConfiguration={_conversationListItemConfiguration?.messageReceiptConfiguration}
