import type { NotificationFeedItem, TimestampGroup } from './CometChatNotificationFeed.types';
...
export class VisibilityTracker {
  ...
  private viewedItems = new Set<string>();
  ...
  private itemMap = new Map<string, NotificationFeedItem>();
