...
const LazyCometChatStickerBubble = lazy(
  () => import('../../components/CometChatStickerBubble/CometChatStickerBubble')
);
...
export const CometChatStickersPlugin: CometChatMessagePlugin = {
  ...
  renderBubble(message: CometChat.BaseMessage, context: CometChatMessagePluginContext) {
    ...
    // The bubble extracts the sticker URL/name from the message itself.
