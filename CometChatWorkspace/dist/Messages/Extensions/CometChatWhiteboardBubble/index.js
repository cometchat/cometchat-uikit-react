...
var CometChatWhiteboardBubble = function CometChatWhiteboardBubble(props) {
  ...
  var _React$useState5 = _react.default.useState(""),
      ...
      whiteboardURL = _React$useState6[0],
      setWhiteboardURL = _React$useState6[1];
  ...
  if (props.messageAlignment === _2.messageAlignment.leftAligned) {
    ...
    }, usernameStyle, whiteboardMessage, messageReactions, /*#__PURE__*/_react.default.createElement("div", {
  ...
  (0, _hooks.Hooks)(props, setName, setAvatar, setWhiteboardURL);
...
CometChatWhiteboardBubble.defaultProps = {
  ...
  whiteboardURL: "",
  iconURL: _collaborativeWhiteboard.default,
  iconTint: "#fff",
  messageObject: null
};
