...
var CometChatAudioBubble = function CometChatAudioBubble(props) {
  ...
  var _React$useState7 = _react.default.useState(""),
      ...
      subTitle = _React$useState8[0],
      setSubTitle = _React$useState8[1];

  var _React$useState9 = _react.default.useState(""),
      _React$useState10 = (0, _slicedToArray2.default)(_React$useState9, 2),
      audioURL = _React$useState10[0],
      setAudioURL = _React$useState10[1];
  ...
  audioMessage = /*#__PURE__*/_react.default.createElement("div", {
  ...
  if (props.messageAlignment === _2.messageAlignment.leftAligned) {
    ...
    }, usernameStyle, audioMessage, messageReactions, messageReplies, receiptStyle);
  } else {
  ...
  (0, _hooks.Hooks)(props, setName, setAvatar, setTitle, setSubTitle, setAudioURL);
