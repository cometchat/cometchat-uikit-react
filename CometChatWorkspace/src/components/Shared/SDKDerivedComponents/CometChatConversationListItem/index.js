...
const CometChatConversationListItem = (props) => {
  ...
  const getAvatar = () => {
    ...
    const cornerRadius =
      props.configurations?.avatarConfiguration?.cornerRadius || "50%";
    const borderWidth =
      props.configurations?.avatarConfiguration?.borderWidth || "1px";
    const borderStyle =
      props.configurations?.avatarConfiguration?.borderStyle || "solid";
    const outerViewWidth =
      props.configurations?.avatarConfiguration?.outerViewWidth || "2px";
    const outerViewStyle =
      props.configurations?.avatarConfiguration?.outerViewStyle || "2px";
    const outerViewSpacing =
      props.configurations?.avatarConfiguration?.outerViewSpacing || "4px";
  ...
  const getPresence = () => {
    ...
    if (
      props.hideStatusIndicator === false &&
      ...
      const width =
        props.configurations?.statusIndicatorConfiguration?.width || "14px";
      const height =
        props.configurations?.statusIndicatorConfiguration?.height || "14px";
      const cornerRadius =
        props.configurations?.statusIndicatorConfiguration?.cornerRadius ||
        "50%";
      const border =
        props.configurations?.statusIndicatorConfiguration?.border ||
        "2px solid #fff";
      const onlineBackgroundColor =
        props.configurations?.statusIndicatorConfiguration
          ?.onlineBackgroundColor || "#3BDF2F";
      const offlineBackgroundColor =
        props.configurations?.statusIndicatorConfiguration
          ?.offlineBackgroundColor || "#C4C4C4";
      const style = props.configurations?.statusIndicatorConfiguration
  ...
  const getUnreadCount = () => {
    if (
      props.hideUnreadCount === false &&
      (props.unreadCount ||
        (props.conversation && props.conversation.unreadMessageCount))
    ) {
      const width =
        props.configurations?.badgeCountConfiguration?.width || "24px";
      const height =
        props.configurations?.badgeCountConfiguration?.height || "20px";
      const cornerRadius =
        props.configurations?.badgeCountConfiguration?.cornerRadius || "11px";
      const borderWidth =
        props.configurations?.badgeCountConfiguration?.borderWidth || "1px";
      const borderStyle =
        props.configurations?.badgeCountConfiguration?.borderStyle || "solid";
  ...
  const getReceiptType = () => {
    ...
    if (props.receipt && receiptTypes.hasOwnProperty(props.receipt)) {
      ...
      const messageWaitIcon =
        props.configurations?.messageReceiptConfiguration?.messageWaitIcon ||
        sendingTick;
      const messageSentIcon =
        props.configurations?.messageReceiptConfiguration?.messageSentIcon ||
        greyTick;
      const messageDeliveredIcon =
        props.configurations?.messageReceiptConfiguration
          ?.messageDeliveredIcon || greyDoubleTick;
      const messageReadIcon =
        props.configurations?.messageReceiptConfiguration?.messageReadIcon ||
        blueDoubleTick;
      const messageErrorIcon =
        props.configurations?.messageReceiptConfiguration?.messageErrorIcon ||
        errorTick;
  ...
  const getThreadIndicator = () => {
    if (
      props.hideThreadIndicator === false &&
      props.conversation &&
      props.conversation.lastMessage &&
      props.conversation.lastMessage.parentMessageId
    ) {
      return (
